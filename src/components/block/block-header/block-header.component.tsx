        ...
        <div className="bi-block-header__line g-flex-column__item g-flex">
          ...
          <div className="bi-block-header__tabs g-flex__item-fixed g-flex">
            ...
            <NavLink
              ...
              activeClassName="bi-block-header__tab--active"
              exact={true}
              to={`/blocks/${this.props.block.number}/transactions`}
            >
            ...
            <NavLink
              ...
              activeClassName="bi-block-header__tab--active"
              exact={true}
              to={`/blocks/${this.props.block.number}/extension`}
            >
            ...
            <NavLink
              ...
              activeClassName="bi-block-header__tab--active"
              exact={true}
              to={`/blocks/${this.props.block.number}/adproofs`}
            >
